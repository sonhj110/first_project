...
for date in range(20230813,20230815) :
    ...
    for dt in yh.select('div.list_body li dt') :
      ...
      if dt.attrs == {} :
          ...
          if yh2.find('article') != None :   # 일반뉴스
            ...
            print(modify(yh2.find('article').text))
            ...
            print(modify(yh2.find('div', id='newsEndContents').text))
            print('스포츠 섹션')
            ...
            print(modify(yh2.find('div', id='articeBody').text))
